...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">Mobile & Data Enthusiast</h3>
            <p className="home__description">I'm an Informatics Student in Bandung National Institute of Technology, and I'm very passionate and dedicated to my work.</p>
